...
function library:New(name)      
	...
	do 
		...
		TextLabel.BorderColor3 = COL3RGB(255, 0, 0) 
...
antiaim:Element("Dropdown", "pitch", {options = {"none", "up", "down", "amogus", "180", "funny", "wind", "wind2", "wind3", "random", "God", "fucker", "cool", "cool2", "back"}})  
...
RunService.RenderStepped:Connect(function(step)     
	...
	if PlayerIsAlive then      
      ...
      if values.rage.angles["body roll"].Dropdown == "-262" then  
			...
			local Pitch = values.rage.angles["pitch"].Dropdown == "none" and 0 or values.rage.angles["pitch"].Dropdown == "up" and 1 or values.rage.angles["pitch"].Dropdown == "down" and -1 or values.rage.angles["pitch"].Dropdown == "amogus" and 15 or values.rage.angles["pitch"].Dropdown == "funny" and 20 or values.rage.angles["pitch"].Dropdown == "wind" and math.huge -5/0 -1 or values.rage.angles["pitch"].Dropdown == "wind2" and 23 or values.rage.angles["pitch"].Dropdown == "cool2" and -13 or values.rage.angles["pitch"].Dropdown == "cool" and 12 or values.rage.angles["pitch"].Dropdown == "back" and -92 or values.rage.angles["pitch"].Dropdown == "God" and 15 or values.rage.angles["pitch"].Dropdown == "fucker" and -13 or values.rage.angles["pitch"].Dropdown == "random" and RANDOM(-100, 100)/10 or 2.5  
			if values.rage.angles["extend pitch"].Toggle and (values.rage.angles["pitch"].Dropdown == "up" or values.rage.angles["pitch"].Dropdown == "down" or values.rage.angles["pitch"].Dropdown == "amogus") then  
				Pitch = (Pitch*2)/1.6  
			end  
